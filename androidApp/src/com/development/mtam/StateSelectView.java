...
public class StateSelectView extends Activity {
	...
	public void onCreate(Bundle savedInstanceState) {
	 ...
	 void showLandmarkList(int index) {
		 
		 Intent i = new Intent(this, LandmarkLayerListView.class);
		 i.putExtra("pointtype", "all");
		 i.putExtra("stateINT", index);
		 i.putExtra("title", STATELIST[index]);
